...
namespace Sop.Data.NhRepositories.Caches.DynamicCacheBuster
{
    ...
    using RootClass = global::NHibernate.Mapping.RootClass;
    ...
    public class CacheBuster
    {
        ...
        /// input to the hash function for each <see cref="RootClass"/>.
        ...
        /// <summary>
        /// Set the delegate used to get an object that will be used as the
        /// input to the hash function for each <see cref="Collection"/>.
