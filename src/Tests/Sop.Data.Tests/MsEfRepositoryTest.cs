...
{
    public class MsEfRepositoryTest
    {

        #region MsEfRepositoryTest
        private readonly IUnitOfWork _unitOfWork;
        private readonly ISchoolRepository _schoolRepository;
        private readonly IStudentRepository _studentRepository;
        private readonly int _count = 10;

        public MsEfRepositoryTest()
        {
        ...
        /// <returns></returns>
        [Fact]
        public void Student_Insert_BeginTransaction_Error()
        {
            ...
            using (var tran = _unitOfWork.BeginTransaction())
            {
                try
                {
                    ...
                    var student1 = new Student
                    {
                        ...
                        FloatValue = 2222222f,
                        DecimalValue = 213123123m,
                        Body = "希望小学-BeginTransaction" + StringHelper.GetRandomString(900),
                        DateCreated = DateTime.Now,
                        SchoolId = newSchool.SchoolId,
                    };
                    _studentRepository.Insert(student1);
                    _unitOfWork.SaveChanges();
                    tran.Commit();
                }
                catch (Exception ex)
            ...
            var newStudent = _studentRepository.TableNoTracking.Where(n => n.SchoolId == newSchool.SchoolId).ToList();
            Assert.False(newStudent.Any());
